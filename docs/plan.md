...
- [x] Accept `.yml` and `.yaml` specs, with clear parse errors and tests.
...
- Make the generated root types filename configurable and required.
...
- Why is the generated root types file emitted separately from schema makers?
